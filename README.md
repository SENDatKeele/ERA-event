...
6. Open one CSV file with the visual plotting extension and complete the shared warm-up.
...
- one numerical finding;
- why the finding matters for Keele;
- one limitation or assumption;
- one thing your group found useful, surprising or difficult.
